...
> **Revised baseline — 2026-09-07:** The [Product Specification v1.0](specs/MachineIQ_ERP_Product_Specification_v1.0.pdf) introduces R1–R10 and changes the release sequence below. Use the [R2 verification and implementation plan](plans/2026-09-07-release2-sales-project-initiation.md) for **Sales and Machine Project Initiation**. This earlier roadmap is retained as historical context; its sales payment/delivery and workflow-engine assignments no longer define revised R2. The new plan includes the release mapping and pending clarifications.
